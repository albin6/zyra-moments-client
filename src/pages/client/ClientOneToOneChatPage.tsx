...
// export function ClientOneToOneChatPage({ vendorId, onClose }: ClientOneToOneChatPageProps) {
...
//       try {
//         const vendorResponse = await clientAxiosInstance.get(`/_cl/client/vendors/${vendorId}`);
...
export function ClientOneToOneChatPage() {
  return (
    <div>ClientOneToOneChatPage</div>
  )
}
